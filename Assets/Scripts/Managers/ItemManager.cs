...
public class ItemManager
{
    ...
    public IEnumerator Initiate()
    {
        ...
        craftables.Add(new Craftable(Items.Revolver, 15, 0, 2, 0, 4, 0, 1, 0, 10f));
        craftables.Add(new Craftable(Items.Antidote, 20, 0, 0, 2, 0, 0, 1, 1, 3.5f));
        craftables.Add(new Craftable(Items.Pistol, 25, 0, 2, 0, 4, 0, 1, 0, 10f));
        ...
        craftables.Add(new Craftable(Items.LowLevelBulletproofHelmet, 48, 0, 0, 0, 7, 0, 1, 0, 14f));
        craftables.Add(new Craftable(Items.Potion, 50, 0, 0, 3, 1, 0, 1, 1, 3.5f));
        craftables.Add(new Craftable(Items.LowLevelBulletproofVest, 52, 0, 0, 0, 10, 0, 1, 0, 14f));
        craftables.Add(new Craftable(Items.BearTrap, 53, 0, 2, 0, 3, 0, 3, 0, 10f));
        craftables.Add(new Craftable(Items.Rocket_Bazooka, 55, 0, 1, 0, 0, 3, 1, 0, 10f));
        craftables.Add(new Craftable(Items.AssaultRifle, 60, 0, 6, 0, 4, 0, 1, 0, 21f));
        craftables.Add(new Craftable(Items.NoiseTrap, 65, 1, 0, 0, 3, 0, 1, 0, 7f));
        craftables.Add(new Craftable(Items.MiddleLevelBulletproofHelmet, 68, 0, 3, 0, 8, 0, 1, 0, 21f));
        craftables.Add(new Craftable(Items.SniperRifle, 70, 0, 6, 0, 4, 0, 1, 0, 21f));
        craftables.Add(new Craftable(Items.MiddleLevelBulletproofVest, 68, 0, 3, 0, 11, 0, 1, 0, 21f));
        craftables.Add(new Craftable(Items.LandMine, 73, 1, 1, 0, 1, 2, 3, 0, 14f));
        craftables.Add(new Craftable(Items.ChemicalTrap, 77, 0, 1, 0, 0, 0, 1, 1, 14f, new KeyValuePair<Items, int>(Items.Poison, 3)));
        craftables.Add(new Craftable(Items.Bazooka, 80, 0, 8, 0, 4, 0, 1, 0, 25f));
        craftables.Add(new Craftable(Items.ShrapnelTrap, 81, 0, 1, 0, 6, 1, 1, 0, 14f));
        craftables.Add(new Craftable(Items.ExplosiveTrap, 85, 1, 0, 1, 0, 3, 1, 0, 14f));
        craftables.Add(new Craftable(Items.HighLevelBulletproofHelmet, 88, 0, 6, 0, 9, 0, 1, 0, 28f));
        craftables.Add(new Craftable(Items.HighLevelBulletproofVest, 92, 0, 6, 0, 12, 0, 1, 0, 28f));
        craftables.Add(new Craftable(Items.BiometricRader, 96, 1, 8, 0, 2, 0, 1, 0, 28f));
        craftables.Add(new Craftable(Items.TrapDetectionDevice, 100, 2, 5, 0, 2, 0, 1, 0, 28f));
        craftables.Add(new Craftable(Items.AdvancedPotion, 104, 0, 0, 3, 0, 0, 1, 1, 3.5f, new KeyValuePair<Items, int>(Items.Potion, 1)));
        craftables.Add(new Craftable(Items.LegendaryBulletproofHelmet, 108, 0, 6, 0, 0, 0, 1, 0, 40f, new KeyValuePair<Items, int>(Items.HighLevelBulletproofHelmet, 1), new KeyValuePair<Items, int>(Items.MiddleLevelBulletproofHelmet, 2), new KeyValuePair<Items, int>(Items.LowLevelBulletproofHelmet, 4)));
        craftables.Add(new Craftable(Items.AdvancedComponent, 110, 0, 4, 0, 0, 0, 1, 0, 14f));
        craftables.Add(new Craftable(Items.LegendaryBulletproofVest, 112, 0, 6, 0, 0, 0, 1, 0, 40f, new KeyValuePair<Items, int>(Items.HighLevelBulletproofVest, 1), new KeyValuePair<Items, int>(Items.MiddleLevelBulletproofVest, 2), new KeyValuePair<Items, int>(Items.LowLevelBulletproofVest, 4)));
        craftables.Add(new Craftable(Items.EnergyBarrier, 116, 2, 4, 0, 8, 0, 1, 0, 28f));
        craftables.Add(new Craftable(Items.LASER, 120, 2, 8, 2, 4, 0, 1, 0, 28f));
        yield return null;
    }
        ...
        switch(wantItem)
        {
            ...
            case Items.Knife:
                for(int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new MeleeWeapon(wantItem, new LocalizedString("Item", wantItem.ToString()), 1, NeedHand.OneHand, DamageType.Slash, 30, 1.7f, 0, quality));
                break;
            case Items.Dagger:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new MeleeWeapon(wantItem, new LocalizedString("Item", wantItem.ToString()), 1, NeedHand.OneHand, DamageType.Slash, 40, 2f, 1, quality));
                break;
            case Items.Bat:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new MeleeWeapon(wantItem, new LocalizedString("Item", wantItem.ToString()), 2, NeedHand.OneOrTwoHand, DamageType.Strike, 35, 2f, 1, quality));
                break;
            case Items.LongSword:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new MeleeWeapon(wantItem, new LocalizedString("Item", wantItem.ToString()), 2, NeedHand.OneOrTwoHand, DamageType.Slash, 50, 2.4f, 1, quality));
                break;
            case Items.Shovel:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new MeleeWeapon(wantItem, new LocalizedString("Item", wantItem.ToString()), 2, NeedHand.OneOrTwoHand, DamageType.Strike, 45, 2f, 1, quality));
                break;
            // Ranged Weapons
            case Items.Pistol:
                for (int i = start; i < end; i++)
            ...
            case Items.LASER:
                for (int i = start; i < end; i++)
                {
                    ...
                    RangedWeapon laser = new(wantItem, new LocalizedString("Item", wantItem.ToString()), 1, NeedHand.OneHand, attackDamage, attackRange, 3f, 10f, 0.5f, 100, 3f, 0, 7, quality);
                    laser.Reload(100);
            ...
            case Items.Bullet_Revolver:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 7));
                break;
            case Items.Bullet_Pistol:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 17));
                break;
            case Items.Bullet_AssaultRifle:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 30));
                break;
            ...
            case Items.Bullet_ShotGun:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 4));
                break;
            case Items.Bullet_SniperRifle:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 5));
                break;
            case Items.Rocket_Bazooka:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 5, quality, 1));
                break;
            case Items.Arrow:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality, 5));
            ...
            case Items.Arrow_Enchanted:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality));
                break;
            // Helmets
            ...
            case Items.BandageRoll:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Consumable(wantItem, new LocalizedString("Item", wantItem.ToString()), 0, quality));
                break;
            ...
            case Items.Components:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Consumable(wantItem, new LocalizedString("Item", wantItem.ToString()), 1, quality));
                break;
            ...
            case Items.BearTrap_Enchanted:
                for (int i = start; i < end; i++)
                {
                    Buriable buriable = new(wantItem, new LocalizedString("Item", wantItem.ToString()), 3, 40, quality);
                    buriable.Enchant();
            ...
            case Items.ChemicalTrap:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new ChemicalTrap(wantItem, new LocalizedString("Item", wantItem.ToString()), 3, quality));
                break;
            ...
            case Items.TrapDetectionDevice:
                for (int i = start; i < end; i++)
                    itemDictionary[wantItem].Add(new Item(wantItem, new LocalizedString("Item", wantItem.ToString()), 2, quality));
                break;
