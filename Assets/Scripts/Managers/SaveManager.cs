...
public static class SaveManager
{
    public static SurvivorSaveData ToSaveData(SurvivorData data)
    {
        var saveData = new SurvivorSaveData
        {
            ...
            craftingPriority1MinimumQuality = data. craftingPriority1MinimumQuality,
            craftingPriority2MinimumQuality = data. craftingPriority2MinimumQuality,
            ...
            mostKillsInASingleMatch = data.mostKillsInASingleMatch,
    ...
    public static SurvivorData FromSaveData(SurvivorSaveData saveData)
    {
            ...
            saveData.fighting, saveData.shooting, saveData.crafting, saveData.knowledge, saveData.price, saveData.tier)
        {
            ...
            priority2Weapon = saveData.priority2Weapon,
            priority1Crafting = saveData.priority1Crafting,
            priority2Crafting = saveData.priority2Crafting,
            priority1CraftingToInt = saveData.priority1CraftingToInt,
            priority2CraftingToInt = saveData.priority2CraftingToInt,
            craftingPriority1MinimumQuality = saveData.craftingPriority1MinimumQuality,
            craftingPriority2MinimumQuality = saveData.craftingPriority2MinimumQuality,
            craftingAllows = saveData.craftingAllows,
            repairCondition = saveData.repairCondition,
            ...
            mostKillsInASingleMatch = saveData.mostKillsInASingleMatch,
