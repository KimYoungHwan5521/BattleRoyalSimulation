...
public class Help : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void SetDescription(ItemManager.Items item)
    {
        ...
        description += item switch
        {
            ...
            ItemManager.Items.Bow => $"\n{new LocalizedString("Basic", "Ranged weapon").GetLocalizedString()}\n{new LocalizedString("Item", "Max Damage").GetLocalizedString()} : 20\n{new LocalizedString("Item", "Attack Range").GetLocalizedString()} : 30",
            ItemManager.Items.AdvancedBow => $"\n{new LocalizedString("Basic", "Ranged weapon").GetLocalizedString()}\n{new LocalizedString("Item", "Max Damage").GetLocalizedString()} : 60\n{new LocalizedString("Item", "Attack Range").GetLocalizedString()} : 60",
            ...
            ItemManager.Items.Arrow => $"\n{new LocalizedString("Item", "Bullet").GetLocalizedString()}",
            ItemManager.Items.Arrow_Enchanted => "",
