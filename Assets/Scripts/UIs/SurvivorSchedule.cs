...
public class SurvivorSchedule : MonoBehaviour
{
    ...
    [SerializeField] Training_FreeManagement curTraining;
    public Training_FreeManagement whereAmI;
    bool amIOrigin = true;

    public void SetSurvivorData(SurvivorData wantSurvivor, Training_FreeManagement curTraining, bool trainable, Transform origin, Transform target)
    {
    ...
    public void Click()
    {
        if (assignable)
        {
            ...
            {
                if (amIOrigin) whereAmI = Training_FreeManagement.None;
